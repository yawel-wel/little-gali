          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 font-body text-medium-gray leading-relaxed">
                <div>
                  <p className="mb-4">
                    אנו מכבדות את פרטיותכם ומתחייבות לשמור על המידע האישי שלכם
                    ועל התמונות שתעלו לאתר. השימוש במידע ובתמונות נעשה אך ורק
                    לצורך מתן השירות, הפקת הספרון האישי והשלמת ההזמנה – ולא לכל
                    מטרה אחרת.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    בעת ביצוע הזמנה באתר נאסף מידע בסיסי כגון שם, כתובת, פרטי
                    תשלום וכתובת דוא״ל. המידע משמש לצורך:
                  </p>
                  <ul className="list-disc list-inside space-y-2 mr-4 mb-4">
                    <li>עיבוד ותיעוד ההזמנה,</li>
                    <li>משלוח המוצר,</li>
                    <li>ומתן שירות לקוחות.</li>
                  </ul>
                  <p>
                    המידע נשמר בצורה מאובטחת ואינו נמסר לצדדים שלישיים, למעט
                    במקרים הנדרשים לצורך ביצוע התשלום או משלוח המוצר, ובהתאם
                    להסכמי סודיות ושמירת פרטיות.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    התמונות שתעלו לאתר משמשות אך ורק לצורך יצירת הספרון האישי
                    שלכם. הן נשמרות במסד נתונים מאובטח לצורך הפקת המוצר, מתן
                    שירות לקוחות או שחזור במקרה של תקלה. לא ייעשה בהן שימוש
                    נוסף, פרסום או העברה לצדדים שלישיים.
                  </p>
                  <p>
                    ניתן לבקש את מחיקת התמונות לאחר השלמת ההפקה באמצעות פנייה
                    אלינו, בכפוף לשיקולים טכניים של גיבוי ותמיכה.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    האתר משתמש באמצעי אבטחה מתקדמים, לרבות הצפנת נתונים ואחסון
                    בשרתים מאובטחים, לצורך הגנה על פרטיותכם. יחד עם זאת, יש
                    לזכור כי אף מערכת אינטרנטית אינה חסינה לחלוטין, ואיננו
                    יכולים להבטיח הגנה מוחלטת מפני חדירה או שימוש לא מורשה.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    כל משתמש רשאי לפנות בכל עת בבקשה לעיון, עדכון, תיקון או
                    מחיקה של המידע האישי שלו, בכפוף להוראות הדין ולצרכים
                    תפעוליים של האתר.
                  </p>
                </div>
