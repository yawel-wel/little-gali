...
export async function POST(
  ...
  const { slotIndex, originalUrl, idempotencyKey } = body;
  ...
  if (!isAllowedCloudinaryUrl(originalUrl)) {
  ...
  const updated = await runSlotGeneration(session, slotIndex, originalUrl);
