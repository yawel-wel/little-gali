              ...
              <div className="space-y-8 font-body text-medium-gray leading-relaxed">
                ...
                <div>
                  ...
                  <p>
                    ...
                    או כל דין אחר. כל האחריות המשפטית בגין התוכן שהועלה חלה על
                    המשתמש בלבד.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    כל ספרון מופק בהתאמה אישית על בסיס התמונות שהועלו. מאחר
                    שמדובר במוצר ייחודי ומותאם אישית, לא ניתן לשנות, לבטל או
                    לבקש החזר לאחר ביצוע ההזמנה, למעט בהתאם למדיניות ההחזרים של
                    האתר.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    השימוש באתר ובמוצר נעשה באחריות המשתמש בלבד. Little Gali
                    אינה אחראית לנזקים עקיפים, אובדן מידע, הפסדים או כל נזק
                    תוצאתי אחר שנגרם עקב שימוש באתר או בשירות.
                  </p>
                </div>
