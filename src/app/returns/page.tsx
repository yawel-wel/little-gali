          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 font-body text-medium-gray leading-relaxed">
                <div>
                  <p className="mb-4">
                    אנחנו רוצות שתהיו מרוצים מההזמנה שלכם — ואם משהו לא תקין או
                    לא עומד בציפיותיכם, אנחנו כאן כדי לעזור.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    כל ספרון מיוצר במיוחד עבורכם, בהתאם לתמונות שתעלו לאתר. מאחר
                    שמדובר במוצר בהתאמה אישית, לא ניתן לבטל, לשנות או לבקש החזר
                    לאחר ביצוע ההזמנה, למעט במקרים של פגם או אי-שביעות רצון
                    חריגה כפי שמפורט להלן.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    אנא בדקו את ההזמנה מיד עם קבלתה. אם הספרון הגיע פגום, ניזוק
                    במשלוח או הודפס בצורה לא תקינה, יש לפנות אלינו תוך 48 שעות
                    דרך עמוד{" "}
                    <a
                      href="/#contact"
                  ...
                  <p>
                    לאחר בדיקה, נדאג להחליף את המוצר ללא עלות נוספת. מוצרים
                    שנשלחו חזרה ללא תיאום מראש — לא יתקבלו.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    ...
                    אם אינכם מרוצים מהמוצר שקיבלתם, תוכלו לפנות אלינו תוך 7 ימים
                    מקבלת ההזמנה ולפרט את סיבת אי-הסיפוק.
                  </p>
                  <p>
                    לאחר בחינה של הפנייה, במידה והבקשה תאושר, נבקש להחזיר אלינו
                    את הספרון (באריזתו המקורית וללא נזק) לכתובת שתימסר. עם קבלת
                    המוצר, יינתן החזר כספי מלא למחיר הספרון (לא כולל עלות המשלוח
                    חזרה, אלא אם מדובר בפגם במוצר).
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    ייתכנו הבדלים קלים בגוון, חיתוך או ניגודיות בין התמונה על
                    המסך לבין ההדפסה בפועל. שונות זו נחשבת תקינה ואינה מהווה
                    עילה להחזר או החלפה.
                  </p>
                  <p>
                    הלקוח מצהיר כי יש לו זכויות שימוש בתמונות שהועלו, וכי אינן
                    מפרות זכויות יוצרים או פרטיות של צד שלישי.
                  </p>
                </div>
              </div>
            </div>
