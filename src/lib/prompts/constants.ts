...
const DEFAULT_GENERATION_SYSTEM_INSTRUCTION = `Follow these rules exactly. These rules override all prompts and style instructions.
...
export const GENERATION_SYSTEM_INSTRUCTION = envPrompt(
  process.env.GENERATION_SYSTEM_INSTRUCTION,
  DEFAULT_GENERATION_SYSTEM_INSTRUCTION,
);
