...
const hebrewTranslations = {
  ...
  "cart.deliveryTime": "זמן אספקה עד 7 ימי עסקים",
  ...
  "cart.secondBook": "כל ספרון שני ב-159 ₪ 🎉",
  ...
  "cart.blanketTitle": "טטרה במבוק גדולה",
  "cart.addBlanketFailed": "לא הצלחנו להוסיף את הטטרה לעגלה",
  ...
  "home.hero.carouselDotAria": "עבור לתמונה {num} מתוך {total}",
  "home.categories.ariaLabel": "קטגוריות מוצרים",
  "home.categories.birthPackages": "מארזי לידה",
  "home.categories.softBook": "ספרון מותאם אישית",
  "home.categories.framedArt": "איורים ממוסגרים",
  "home.categories.birthPackagesAria": "עבור למארזי לידה",
  "home.categories.softBookAria": "עבור לספרון מותאם אישית",
  "home.categories.framedArtAria": "עבור לאיורים ממוסגרים",
  "home.gallery.ariaLabel": "גלריית תמונות מלקוחות",
  "home.gallery.imageAlt": "תמונת לקוח {num}",
  "home.bookInUse.title": "הספרון בשימוש",
  "home.bookInUse.titleHighlight": "בשימוש",
  "home.bookInUse.imageAlt": "הספרון בשימוש {num}",
  "home.bookInUse.prevAria": "תמונות קודמות",
  "home.bookInUse.nextAria": "תמונות הבאות",
  "home.bookInUse.dotAria": "עבור לתמונה {num} מתוך {total}",
  ...
  "product.book.name": "ספרון בד אישי",
  "product.book.description.intro":
    "ספרון בד אישי עם איורים שנוצרו מהתמונות שלכם.\nלזמן בטן, לעגלה - וגם כמתנת לידה שהיא באמת אישית.",
  "product.book.description.bullet1": "איורים שנוצרים מהתמונות שלכם",
  "product.book.description.bullet2": "תמונות נשלפות",
  "product.book.description.bullet3": "כולל מראה מובנית",
  "product.book.description.bullet4": "פיתוח מקורי",
  "product.book.description.bullet5": "באישור מכון התקנים",
  "product.book.description.bullet6": "מתאים מגיל לידה",
  "product.book.description.bullet7": "קופסא מעוצבת מתנה",
  "product.book.badge": "ספרון שני ב-₪{price}",
  "product.book.googleReviews": "ביקורות ב-Google",
  "product.book.reviewsLink": "ביקורות",
  "product.book.openReviews": "פתיחת ביקורות המוצר",
  "product.book.reviewsTitle": "מה הלקוחות שלנו מספרים",
  "product.book.reviewsCount": "{count} ביקורות",
  "product.book.reviewsError": "לא הצלחנו לטעון את הביקורות",
  "product.book.reviewsRetry": "נסו שוב",
  "product.book.noReviews": "עדיין אין ביקורות למוצר הזה",
  "product.book.ratingAria": "{count} ביקורות חמישה כוכבים ב-Google",
  "product.book.breadcrumbAria": "ניווט מסלול",
  "product.book.breadcrumbHome": "בית",
  "product.book.breadcrumbProduct": "ספרון בד אישי",
  "product.book.shippingNote": "עלות המשלוח מחושבת בקופה",
  "product.pickup.title": "איסוף עצמי מבבלי תל אביב",
  "product.pickup.subtitle": "בדרך כלל מוכן בתוך 48 שעות",
  "product.pickup.price": "חינם",
  "product.delivery.title": "משלוח עד הבית",
  "product.delivery.subtitle": "עד 7 ימי עסקים",
  "product.delivery.price": "30 ₪",
  "product.book.inStock": "במלאי",
  "product.book.colorLabel": "צבע",
  "product.book.ctaPrimary": "צרו את הספרון האישי שלכם",
  "product.book.ctaSecondary": "התחילו לעצב",
  "product.book.ctaSticky": "התחילו ליצור",
  "product.blanket.upsellTitle": "שדרגו למארז",
  "product.blanket.name": "טטרה במבוק גדולה",
  "product.blanket.pdpName": "טטרת במבוק גדולה",
  "product.blanket.description":
    "מידה: 110*120 ס״מ\nחיתול בד גדול לתינוק עשוי במבוק רך ונעים.\nהטטרה יכולה לשמש כחיתול עיטוף כדי לעזור להרגיע את התינוק\nהוא יכול לשמש כסינר הנקה, כחיתול פליטה, כמשטח פעילות, כצילון לעגלה ועוד.\n\nהרכב הבד: 70% במבוק, 30% כותנה.\nהוראות כביסה: כביסה עדינה, יבוש בצל",
  "product.blanket.colorLabel": "צבע",
  "product.blanket.addToCart": "הוסף לעגלה",
  "product.blanket.addingToCart": "מוסיפים לעגלה...",
  "product.blanket.pattern.dots": "נקודות",
  "product.blanket.pattern.leopard": "מנומר",
  "product.blanket.patternAria": "בחירת דוגמה: {pattern}",
  "product.blanket.breadcrumbAria": "ניווט פירורי לחם",
  "product.blanket.breadcrumbHome": "דף הבית",
  ...
  "product.birthPackage.description":
    "מארז הלידה שלנו כולל ספרון בד עם האיורים שלכם וטטרת במבוק גדולה ומפנקת.\nהמארז מגיע בקופסה מעוצבת ותוכלו גם להוסיף כרטיס ברכה בניסוח שלכם.\nמתנת לידה מושלמת לחברה שילדה או לעצמכם.",
  "product.birthPackage.breadcrumbAria": "ניווט פירורי לחם",
  "product.birthPackage.breadcrumbProduct": "מארזי לידה",
  "product.birthPackage.gallery.imageAlt": "מארז לידה {print} - תמונה {num}",
  "product.birthPackage.tabs.descriptionContent":
    "ספרון הבד של Little Gali נוצר כדי להכיר לתינוק את האנשים החשובים ביותר בחייו כבר מהימים הראשונים.\nבמקום איורים גנריים או חיות, הספרון מציג את המשפחה שלו - הורים, אחים, סבים, סבתות וכל מי שהוא אוהב.\nאתם מעלים את התמונות באתר, ואנחנו הופכים אותן לאיורים ייחודיים שנכנסים לכיסים השקופים שבספרון.\nהספרון הוא דו צדדי ואתם יכולים לבחור איך הוא יאוכלס: אפשר צד אחד עם תמונות בשחור-לבן וצד שני צבעוני ואפשר ששני הצדדים יהיו צבעוניים.\nהמראה המובנית מוסיפה עניין ומשחק, והאפשרות להחליף את סדר התמונות מאפשרת לרענן את הספרון בכל פעם מחדש.\nהוא רך, קל לנשיאה ומתאים לעגלה, לעריסה, לזמן בטן ולכל יציאה מהבית.\n\nהטטרה הגדולה שלנו עשויה במבוק רך ונעים.\nהטטרה יכולה לשמש כחיתול עיטוף כדי לעזור להרגיע את התינוק, כסינר הנקה, חיתול פליטה, משטח פעילות, צילון לעגלה ועוד.",
  "product.birthPackage.goodToKnow.bookHeading": "ספרון בד",
  "product.birthPackage.goodToKnow.blanketHeading": "טטרה",
  "product.birthPackage.goodToKnow.blanket.dimensions.title": "המידות שלי",
  "product.birthPackage.goodToKnow.blanket.dimensions.line1": "110*100 ס״מ",
  "product.birthPackage.goodToKnow.blanket.fabric.title": "הרכב הבד",
  "product.birthPackage.goodToKnow.blanket.fabric.line1": "70% במבוק, 30% כותנה",
  "product.birthPackage.goodToKnow.blanket.care.title": "הוראות כביסה",
  "product.birthPackage.goodToKnow.blanket.care.line1": "כביסה עדינה, יבוש בצל",
  "cart.birthPackageTitle": "מארז מתנה - {pattern}",
  "product.book.prevImage": "תמונה קודמת",
  "product.book.nextImage": "תמונה הבאה",
  "product.book.gallery.imageAlt": "ספרון בד אישי {color} - תמונה {num}",
  "product.book.stickyBarAria": "סרגל פעולות מוצר",
  "product.book.share": "שיתוף",
  "product.book.askQuestion": "שאלו אותנו",
  "product.book.viewAllQa": "לכל השאלות והתשובות",
  "product.book.trust.preview": "תצוגה מקדימה חינם לפני הרכישה",
  "product.book.trust.secondBook": "ספר שני ב-₪{price}",
  "product.book.trust.delivery": "זמן אספקה עד 7 ימי עסקים",
  "product.book.highlights.title": "נקודות מרכזיות",
  "product.book.myHighlights.title": "עלי בקיצור",
  "product.book.myHighlights.item1": "ספרון אישי עם איורים של האנשים שהתינוק הכי אוהב",
  "product.book.myHighlights.item2": "תצוגה מקדימה חינם לפני הרכישה",
  "product.book.myHighlights.item3": "דו צדדי: צד אחד שחור-לבן וצד שני צבעוני",
  "product.book.myHighlights.item4": "ניתן להחליף את סדר התמונות",
  "product.book.myHighlights.item5": "מראה בטיחותית מובנית באחד הצדדים",
  "product.book.myHighlights.item6": "מתאים לעגלה, לעריסה ולזמן בטן",
  "product.book.myHighlights.item7": "מאושר ע\"י מכון התקנים הישראלי",
  "product.book.tabs.ariaLabel": "מידע על המוצר",
  "product.book.tabs.description": "תיאור",
  "product.book.tabs.goodToKnow": "כדאי לדעת",
  "product.book.goodToKnow.dimensions.title": "המידות שלי",
  "product.book.goodToKnow.dimensions.line1": "אורך - 69 ס״מ",
  "product.book.goodToKnow.dimensions.line2": "גובה - 16 ס״מ",
  "product.book.goodToKnow.care.title": "איך לנקות אותי",
  "product.book.goodToKnow.care.line1": "עם מטלית לחה",
  ...
  "product.book.highlights.item2.subtitle": "תת-כותרת 2",
  "product.book.highlights.item3.title": "כותרת 3",
  "product.book.highlights.item3.subtitle": "תת-כותרת 3",
  "product.book.service.item1": "ספר שני ב-₪159",
  ...
  "product.book.accordion.overviewContent":
    "ספרון הבד של Little Gali נוצר כדי להכיר לתינוק את הפנים הכי מוכרות ואהובות עליו – כבר מהימים הראשונים.\n\nאתם בוחרים תמונות של ההורים, האחים, הסבים, הסבתות או כל מי שתרצו שיופיע בספרון, ואנחנו הופכים אותן לאיורים אישיים במיוחד עבורכם.\n\nהספרון דו־צדדי וזמין בשתי גרסאות: שחור־לבן וצבעוני, או צבעוני משני הצדדים. בתוכו תמצאו גם מראה מובנית, ואת האיורים אפשר להוציא מהכיסים ולהחליף ביניהם – כך שאפשר לשנות את הסדר ולרענן את הספרון מתי שרוצים.\n\nהוא רך וקל לנשיאה, ומתאים לזמן בטן, לעגלה, לעריסה או פשוט לרגע קטן יחד בבית.",
  ...
  "product.book.accordion.details": "פרטים נוספים",
  "product.book.accordion.detailsContent":
    "הספרון נבדק ואושר על ידי מכון התקנים הישראלי.\n\nצד אחד כולל איורים בשחור־לבן עם ניגודיות גבוהה, והצד השני כולל איורים צבעוניים.\n\nניתן לנקות בעדינות עם מטלית לחה. מתאים לעגלה ולזמן בטן.",
  ...
  "home.framedArt.cta": "התחילו כאן",
  "home.framedArt.ctaAriaLabel": "עבור לעמוד המוצר של האיור הממוסגר",
  ...
  "home.framedArt.features.noDrill.subtitle":
    "התמונות מגיעות עם מדבקות מגנט מיוחדות להדבקה על הקיר",
  ...
  "product.framedArt.name": "איור ממוסגר אישי",
  "product.framedArt.breadcrumbAria": "ניווט מסלול",
  "product.framedArt.breadcrumbHome": "בית",
  "product.framedArt.breadcrumbProduct": "איור ממוסגר",
  "product.framedArt.gallery.imageAlt": "איור ממוסגר אישי - תמונה {num}",
  "product.framedArt.description.intro":
    "תמונה אהובה שהופכת לאיור אמנותי, מגיעה ממוסגרת ומוכנה לתלייה.\nהתלייה מגנטית לחלוטין - בלי קידוח, בלי מסמרים.",
  "product.framedArt.description.bullet1": "איור שנוצר מהתמונה שלכם",
  "product.framedArt.description.bullet2":
    "3 סגנונות איור לבחירה - עפרונות צבעוניים, קריקטורה וצבעי מים",
  "product.framedArt.description.bullet3": "תצוגה מקדימה חינם לפני הרכישה",
  "product.framedArt.description.bullet4": "תלייה מגנטית ללא קידוח",
  "product.framedArt.description.bullet5": "מסגרת 20x20 ס״מ בגימור דמוי עץ",
  "product.framedArt.description.bullet6": "מתנה אישית שאי אפשר לקבל פעמיים",
  "product.framedArt.tabs.ariaLabel": "מידע על המוצר",
  "product.framedArt.tabs.description": "תיאור",
  "product.framedArt.tabs.goodToKnow": "כדאי לדעת",
  "product.framedArt.accordion.overviewContent":
    "האיור הממוסגר של Little Gali הופך תמונה אהובה ליצירת אמנות אישית שתלויה על הקיר.\nאתם מעלים תמונה אחת, בוחרים את סגנון האיור שאתם הכי אוהבים, ואנחנו הופכים אותה לאיור ייחודי שמודפס ומגיע ממוסגר ומוכן לתלייה.\nהמסגרת נתלית בעזרת מדבקות מגנט - בלי קידוח, בלי מסמרים ובלי חורים בקיר. אפשר להסיר ולהזיז אותה, כך שתוכלו לשנות את הסידור מתי שבא לכם.\nאפשר להזמין תמונה בודדת או סט של 2-3 תמונות וליצור קיר גלריה משפחתי.\nלפני שמזמינים תוכלו לראות תצוגה מקדימה של האיור ולוודא שהוא מוצא חן בעיניכם.",
  "product.framedArt.goodToKnow.dimensions.title": "המידות שלי",
  "product.framedArt.goodToKnow.dimensions.line1": "גודל - 20x20 ס״מ",
  "product.framedArt.goodToKnow.dimensions.line2": "עובי - 1.5 ס״מ",
  "product.framedArt.goodToKnow.material.title": "ממה אני עשוי",
  "product.framedArt.goodToKnow.material.line1": "מסגרת MDF בגימור דמוי עץ",
  "product.framedArt.goodToKnow.material.line2": "בגוון אלון בהיר",
  "product.framedArt.goodToKnow.hanging.title": "איך תולים אותי",
  "product.framedArt.goodToKnow.hanging.line1": "מדבקות מגנט - ללא קידוח וללא מסמרים",
  "product.framedArt.goodToKnow.care.title": "איך לנקות אותי",
  "product.framedArt.goodToKnow.care.line1": "עם מטלית יבשה או לחה מעט",
  "product.framedArt.goodToKnow.care.line2": "אין להשתמש בחומרי ניקוי",
  "product.framedArt.goodToKnow.wallNoteTitle": "שימו לב:",
  "product.framedArt.goodToKnow.wallNote":
    "כדי להימנע מנזק, מומלץ לא להדביק את המדבקות על טפטים, משטחים עדינים או קירות סדוקים.",
  "product.framedArt.cta": "התחילו ליצור",
  "product.framedArt.ctaAriaLabel": "התחילו ליצור איור ממוסגר",
  "product.framedArt.askQuestion": "שאלו אותנו",
  "product.framedArt.qa.subtitle": "התשובות לשאלות הנפוצות ביותר על האיור הממוסגר",
  ...
  "cart.suggest.bookTitle": "ספרון בד",
  "cart.suggest.framedArtTitle": "איור ממוסגר",
  "cart.suggest.blanketTitle": "טטרה במבוק גדולה",
  "cart.suggest.bookPromo": "שני ב-159₪",
  "cart.suggest.framedArtPromo": "איור שני ב99 ש״ח",
  "cart.suggest.blanketPromo": "₪89",
  ...
  "home.howItWorks.step1.description":
    "בחרו את התמונות שיופיעו בספרון",
  ...
  "home.howItWorks.cta": "התחילו כאן",
  ...
  "home.special.title": "למה לבחור בנו",
  "home.special.titleHighlight": "בנו",
  "home.special.subtitleLine1": "חיפשנו ולא מצאנו - אז המצאנו.",
  "home.special.ariaLabel": "למה לבחור בנו",
  ...
  "qa.questionGift":
    "אני רוצה לקנות את הספרון במתנה. האם אני חייב לבחור את התמונות בעצמי?",
  "qa.answerGift":
  ...
  "qa.answerSimilarity":
    "כן, מערכת האיור שלנו נועדה לשמור על המאפיינים הייחודיים של כל אדם – תווי פנים, הבעות ושיער – תוך התאמת התמונה לסגנון האיור של הספרון.\n\nעם זאת, עדיין מדובר באיור ולא בתמונה ריאליסטית ולכן יכולים להיות הבדלים קטנים בין התמונה המקורית לאיור שנוצר. בדיוק בשביל כך יש אפשרות לראות את האיורים לפני שמבצעים את הרכישה, כדי לראות את התוצאה ולאשר אותה.",
  ...
  "contact.sidebarTitle": "איך נוכל לעזור?",
  "contact.sidebarSubtitle":
    "מחכים לשמוע מכם — נחזור אליכם תוך 24 שעות בימי עסקים",
  "contact.mobileSubtitle": "מחכים לשמוע מכם — נחזור אליכם תוך 24 שעות",
  "contact.orDivider": "או",
  "contact.responseTime": "זמן מענה: עד 24 שעות",
  "contact.supportEmail": "support@littlegali.com",
  "contact.deliveryTime": "הזמנות מגיעות עד 14 ימי עסקים",
  "contact.sidebarReturns": "מדיניות החזרות",
  "contact.sidebarOrderTracking": "מעקב הזמנה",
  "contact.sidebarFaq": "שאלות נפוצות",
  ...
  "contact.namePlaceholder": "הכניסו את שמכם",
  "contact.emailPlaceholder": "your@email.com",
  "contact.subjectPlaceholder": "לגבי הזמנה / מוצר / שאלה כללית",
  "contact.messagePlaceholder": "ספרו לנו הכל - נשמח לעזור",
  ...
  "contact.previewLinked":
    "במידה ויש, התצוגה המקדימה שלכם תישלח אלינו אוטומטית עם ההודעה כדי שנבין במה מדובר",
  "contact.previewLinkedMobile":
    "אם ההודעה שלכם קשורה להזמנה קיימת, התצוגה המקדימה תישלח אוטומטית",
  "contact.attachments": "צרפו תמונות (לא חובה)",
  "contact.attachmentsLimitHint": "עד 5 תמונות",
  "contact.attachmentsLimitHintShort": "עד 5",
  ...
  "upload.description":
    "בחרו את חמשת התמונות שיופיעו בספרון.\nמכל תמונה ניצור איור צבעוני ואיור בשחור־לבן.",
  ...
  "upload.imagesCount": "מתוך 5",
  "upload.imagesCount9": "מתוך 9 תמונות",
  "upload.selectExactly5": "אנא בחר בדיוק 5 תמונות",
  "upload.selectExactly9": "אנא בחר בדיוק 9 תמונות",
  "upload.chooser.ariaLabel": "בחירת סוג ספרון",
  "upload.chooser.title": "איזה ספרון תרצו ליצור",
  ...
  "upload.chooser.classicBadge": "5 תמונות",
  "upload.chooser.classicFeature1": "צד בשחור לבן",
  "upload.chooser.classicFeature2": "צד שני צבעוני",
  "upload.chooser.classicFeature3": "כולל מראה",
  "upload.chooser.classicFeature4": "5 תמונות",
  "upload.chooser.colorfulTitle": "ספרון צבעוני",
  "upload.chooser.colorfulDescription":
    "שני הצדדים יכילו תמונות צבעוניות שונות",
  "upload.chooser.colorfulBadge": "9 תמונות",
  "upload.chooser.colorfulFeature1": "שני צדדים צבעוניים",
  "upload.chooser.colorfulFeature2": "תמונות שונות בכל צד",
  "upload.chooser.colorfulFeature3": "כולל מראה",
  "upload.chooser.colorfulFeature4": "9 תמונות",
  ...
  "upload.previousSessions.cardTitle": "הספרון שלכם ממתין",
  "upload.previousSessions.sectionTitle": "המשיכו מאיפה שהפסקתם",
  "upload.previousSessions.continue": "המשיכו מהנקודה שבה עצרתם",
  "upload.previousSessions.goToCart": "לעגלה",
  "upload.previousSessions.viewPreview": "צפייה בתצוגה",
  "upload.previousSessions.dismissSession": "הסתר",
  "upload.previousSessions.orUploadNew": "או העלו תמונות חדשות למטה",
  "upload.previousSessions.orChooseType": "או צרו ספרון חדש למטה",
  "upload.previousSessions.badge.classic": "ספרון קלאסי · 5 תמונות",
  "upload.previousSessions.badge.colorful": "ספרון צבעוני · 9 תמונות",
  "upload.previousSessions.resumeError": "לא הצלחנו לפתוח את התצוגה המקדימה. נסו שוב.",
  "upload.previousSessions.createdRelative": "נוצר {relative}",
  "upload.previousSessions.updatedYesterday": "אתמול",
  "upload.previousSessions.changesRemaining": "{count} שינויים נותרו",
  "upload.previousSessions.changesExhausted": "אין שינויים נוספים · עדיין אפשר להזמין",
  "upload.previousSessions.status.generating": "מכינים תצוגה",
  "upload.previousSessions.status.reviewBw": "שלב שחור-לבן",
  "upload.previousSessions.status.pickStyle": "שלב צבעוני",
  "upload.previousSessions.status.readyToOrder": "מוכן להזמנה",
  "upload.previousSessions.status.inCart": "בעגלה",
  ...
  "preview.colorfulLoadingTitle": "יוצרים את האיורים הצבעוניים",
  "preview.colorfulLoadingLine1": "מעבדים את התמונות שלכם",
  "preview.colorfulLoadingLine2": "מציירים בטושים צבעוניים",
  "preview.colorfulLoadingLine3": "שומרים על הדמיון אליכם",
  "preview.colorfulLoadingLine4": "בודקים שהכל נראה טוב",
...
const englishTranslations = {
  ...
  "cart.deliveryTime": "Delivery time up to 7 business days",
  ...
  "cart.secondBook": "Every second book for ₪159 🎉",
  ...
  "cart.blanketTitle": "Large bamboo blanket",
  "cart.addBlanketFailed": "We couldn't add the blanket to the cart",
  ...
  "home.hero.cta": "Start here",
  "home.hero.ariaLabel": "Hero section",
  "home.hero.imageAlt": "Baby book examples",
  "home.hero.ctaAriaLabel": "Go to book creation page",
  "home.hero.carouselDotAria": "Go to image {num} of {total}",
  "home.categories.ariaLabel": "Product categories",
  "home.categories.birthPackages": "Birth packages",
  "home.categories.softBook": "Personalized fabric book",
  "home.categories.framedArt": "Framed illustrations",
  "home.categories.birthPackagesAria": "Go to birth packages",
  "home.categories.softBookAria": "Go to personalized fabric book",
  "home.categories.framedArtAria": "Go to framed illustrations",
  "home.gallery.ariaLabel": "Customer photo gallery",
  "home.gallery.imageAlt": "Customer photo {num}",
  "home.bookInUse.title": "The book in use",
  "home.bookInUse.titleHighlight": "use",
  "home.bookInUse.imageAlt": "Book in use {num}",
  "home.bookInUse.prevAria": "Previous images",
  "home.bookInUse.nextAria": "Next images",
  "home.bookInUse.dotAria": "Go to image {num} of {total}",
  ...
  "product.book.name": "Personal Fabric Book",
  "product.book.description.intro":
    "A personal fabric book with illustrations created from your photos.\nFor tummy time, the stroller — and a birth gift that's truly personal.",
  "product.book.description.bullet1": "Illustrations created from your photos",
  "product.book.description.bullet2": "Removable photos",
  "product.book.description.bullet3": "Includes a built-in mirror",
  "product.book.description.bullet4": "Original design",
  "product.book.description.bullet5": "Standards Institute approved",
  "product.book.description.bullet6": "Suitable from birth",
  "product.book.description.bullet7": "Designed gift box",
  "product.book.badge": "Second book for ₪{price}",
  "product.book.googleReviews": "Google reviews",
  "product.book.reviewsLink": "Reviews",
  "product.book.openReviews": "Open product reviews",
  "product.book.reviewsTitle": "What our customers say",
  "product.book.reviewsCount": "{count} reviews",
  "product.book.reviewsError": "We couldn't load the reviews",
  "product.book.reviewsRetry": "Try again",
  "product.book.noReviews": "There are no reviews for this product yet",
  "product.book.ratingAria": "{count} five-star Google reviews",
  "product.book.breadcrumbAria": "Breadcrumb navigation",
  "product.book.breadcrumbHome": "Home",
  "product.book.breadcrumbProduct": "Personal Fabric Book",
  "product.book.shippingNote": "Shipping calculated at checkout",
  "product.pickup.title": "Self-pickup from Bavli, Tel Aviv",
  "product.pickup.subtitle": "Usually ready within 48 hours",
  "product.pickup.price": "Free",
  "product.delivery.title": "Home delivery",
  "product.delivery.subtitle": "Up to 7 business days",
  "product.delivery.price": "₪30",
  "product.book.inStock": "In stock",
  "product.book.colorLabel": "Color",
  "product.book.ctaPrimary": "Create your personal book",
  "product.book.ctaSecondary": "Start designing",
  "product.book.ctaSticky": "Start creating",
  "product.blanket.upsellTitle": "Upgrade to a set",
  "product.blanket.name": "Large bamboo blanket",
  "product.blanket.pdpName": "Large bamboo blanket",
  "product.blanket.description":
    "Size: 110×120 cm\nA large soft bamboo baby cloth.\nUse it as a swaddle to soothe baby, a nursing cover, spit-up cloth, play mat, stroller shade, and more.\n\nFabric: 70% bamboo, 30% cotton.\nCare: gentle wash, dry in the shade",
  "product.blanket.colorLabel": "Color",
  "product.blanket.addToCart": "Add to cart",
  "product.blanket.addingToCart": "Adding to cart...",
  "product.blanket.pattern.dots": "Dots",
  "product.blanket.pattern.leopard": "Leopard",
  "product.blanket.patternAria": "Choose pattern: {pattern}",
  "product.blanket.breadcrumbAria": "Breadcrumb navigation",
  "product.blanket.breadcrumbHome": "Home",
  ...
  "product.birthPackage.description":
    "Our birth package includes a fabric book with your illustrations and a large, cozy bamboo blanket.\nThe set arrives in a designed gift box, and you can also add a greeting card with your own message.\nA perfect birth gift for a friend who just gave birth — or for yourselves.",
  "product.birthPackage.breadcrumbAria": "Breadcrumb navigation",
  "product.birthPackage.breadcrumbProduct": "Birth packages",
  "product.birthPackage.gallery.imageAlt": "Birth package {print} - image {num}",
  "product.birthPackage.tabs.descriptionContent":
    "Little Gali's fabric book is designed to introduce your baby to the most important people in their life from the very first days.\nInstead of generic illustrations or animals, the book shows their family - parents, siblings, grandparents, and everyone they love.\nYou upload photos on the site, and we turn them into unique illustrations that slide into the book's clear pockets.\nThe book is double-sided, and you can choose how it's filled: one side black-and-white and the other colorful, or both sides colorful.\nThe built-in mirror adds interest and play, and the option to reorder photos lets you refresh the book every time.\nIt's soft, easy to carry, and great for the stroller, crib, tummy time, and every outing.\n\nOur large bamboo blanket is soft and cozy.\nIt can be used as a swaddle to soothe baby, a nursing cover, spit-up cloth, play mat, stroller shade, and more.",
  "product.birthPackage.goodToKnow.bookHeading": "Fabric book",
  "product.birthPackage.goodToKnow.blanketHeading": "Blanket",
  "product.birthPackage.goodToKnow.blanket.dimensions.title": "My dimensions",
  "product.birthPackage.goodToKnow.blanket.dimensions.line1": "110×100 cm",
  "product.birthPackage.goodToKnow.blanket.fabric.title": "Fabric",
  "product.birthPackage.goodToKnow.blanket.fabric.line1": "70% bamboo, 30% cotton",
  "product.birthPackage.goodToKnow.blanket.care.title": "Care instructions",
  "product.birthPackage.goodToKnow.blanket.care.line1": "Gentle wash, dry in the shade",
  "cart.birthPackageTitle": "Gift set - {pattern}",
  "product.book.prevImage": "Previous image",
  "product.book.nextImage": "Next image",
  "product.book.gallery.imageAlt": "Personal fabric book {color} - image {num}",
  "product.book.stickyBarAria": "Product action bar",
  "product.book.share": "Share",
  "product.book.askQuestion": "Ask a question",
  "product.book.viewAllQa": "View all questions & answers",
  "product.book.trust.preview": "Free preview before purchase",
  "product.book.trust.secondBook": "Second book for ₪{price}",
  "product.book.trust.delivery": "Delivery within 7 business days",
  "product.book.highlights.title": "Product highlights",
  "product.book.myHighlights.title": "My highlights",
  "product.book.myHighlights.item1": "A personal book illustrated with the people your baby loves most",
  "product.book.myHighlights.item2": "Free preview before purchase",
  "product.book.myHighlights.item3": "Double-sided: one black-and-white side and one colorful side",
  "product.book.myHighlights.item4": "Reorder photos anytime",
  "product.book.myHighlights.item5": "Built-in safety mirror on one side",
  "product.book.myHighlights.item6": "Great for the stroller, crib, and tummy time",
  "product.book.myHighlights.item7": "Approved by the Israeli Standards Institute",
  "product.book.tabs.ariaLabel": "Product information",
  "product.book.tabs.description": "Description",
  "product.book.tabs.goodToKnow": "Good to know",
  "product.book.goodToKnow.dimensions.title": "My dimensions",
  "product.book.goodToKnow.dimensions.line1": "Length — 69 cm",
  "product.book.goodToKnow.dimensions.line2": "Height — 16 cm",
  "product.book.goodToKnow.care.title": "How to clean me",
  "product.book.goodToKnow.care.line1": "With a damp cloth",
  ...
  "product.book.highlights.item2.subtitle": "Subtitle 2",
  "product.book.highlights.item3.title": "Title 3",
  "product.book.highlights.item3.subtitle": "Subtitle 3",
  "product.book.service.item1": "Second book for ₪159",
  "product.book.service.item2": "Delivery within 7 business days",
  "product.book.accordion.overview": "Overview",
  "product.book.accordion.overviewContent":
    "Little Gali's fabric book was created to introduce your baby to the most familiar and beloved faces — from the very first days.\n\nYou choose photos of the parents, siblings, grandparents, or anyone you want in the book, and we turn them into personal illustrations made especially for you.\n\nThe book is double-sided and available in two versions: black-and-white and color, or color on both sides. Inside you'll also find a built-in mirror, and the illustrations can be taken out of the pockets and swapped — so you can change the order and refresh the book whenever you like.\n\nIt's soft and easy to carry, and great for tummy time, the stroller, the crib, or simply a small moment together at home.",
  ...
  "product.book.accordion.details": "More details",
  "product.book.accordion.detailsContent":
    "The book is tested and approved by the Israeli Standards Institute.\n\nOne side features high-contrast black-and-white illustrations, and the other side features colorful illustrations.\n\nGently wipe clean with a damp cloth. Stroller-friendly and great for tummy time.",
  ...
  "home.framedArt.cta": "Start here",
  "home.framedArt.ctaAriaLabel": "Go to the framed illustration product page",
  ...
  "home.framedArt.features.noDrill.subtitle":
    "Frames come with special magnetic stickers that mount straight onto the wall.",
  ...
  "product.framedArt.name": "Personal framed illustration",
  "product.framedArt.breadcrumbAria": "Breadcrumb navigation",
  "product.framedArt.breadcrumbHome": "Home",
  "product.framedArt.breadcrumbProduct": "Framed illustration",
  "product.framedArt.gallery.imageAlt": "Personal framed illustration - image {num}",
  "product.framedArt.description.intro":
    "A cherished photo turned into artwork, delivered framed and ready to hang.\nMounting is fully magnetic — no drilling and no nails.",
  "product.framedArt.description.bullet1": "An illustration created from your photo",
  "product.framedArt.description.bullet2":
    "Three illustration styles — colored pencils, cartoon, and watercolor",
  "product.framedArt.description.bullet3": "Free preview before you buy",
  "product.framedArt.description.bullet4": "Magnetic mounting, no drilling",
  "product.framedArt.description.bullet5": "20×20 cm frame with a wood-look finish",
  "product.framedArt.description.bullet6": "A personal gift no one else can give twice",
  "product.framedArt.tabs.ariaLabel": "Product information",
  "product.framedArt.tabs.description": "Description",
  "product.framedArt.tabs.goodToKnow": "Good to know",
  "product.framedArt.accordion.overviewContent":
    "Little Gali's framed illustration turns a photo you love into personal artwork for your wall.\nUpload one photo, choose the illustration style you like best, and we turn it into a unique illustration that arrives printed, framed, and ready to hang.\nThe frame mounts with magnetic stickers — no drilling, no nails, and no holes in your wall. It can be taken off and moved, so you can rearrange whenever you feel like it.\nOrder a single frame or a set of two or three and build a family gallery wall.\nBefore you order, you'll see a preview of the illustration so you can be sure you love it.",
  "product.framedArt.goodToKnow.dimensions.title": "My dimensions",
  "product.framedArt.goodToKnow.dimensions.line1": "Size - 20×20 cm",
  "product.framedArt.goodToKnow.dimensions.line2": "Depth - 1.5 cm",
  "product.framedArt.goodToKnow.material.title": "What I'm made of",
  "product.framedArt.goodToKnow.material.line1": "MDF frame with a wood-look finish",
  "product.framedArt.goodToKnow.material.line2": "Light oak shade",
  "product.framedArt.goodToKnow.hanging.title": "How to hang me",
  "product.framedArt.goodToKnow.hanging.line1": "Magnetic stickers - no drilling, no nails",
  "product.framedArt.goodToKnow.care.title": "How to clean me",
  "product.framedArt.goodToKnow.care.line1": "With a dry or slightly damp cloth",
  "product.framedArt.goodToKnow.care.line2": "Do not use cleaning products",
  "product.framedArt.goodToKnow.wallNoteTitle": "Please note:",
  "product.framedArt.goodToKnow.wallNote":
    "To avoid damage, we recommend not sticking the adhesive on wallpaper, delicate surfaces, or cracked walls.",
  "product.framedArt.cta": "Start creating",
  "product.framedArt.ctaAriaLabel": "Start creating a framed illustration",
  "product.framedArt.askQuestion": "Ask us a question",
  "product.framedArt.qa.subtitle":
    "Answers to the most common questions about the framed illustration",
  ...
  "cart.suggest.blanketTitle": "Large bamboo blanket",
  "cart.suggest.bookPromo": "2 for ₪159",
  "cart.suggest.framedArtPromo": "Second frame for ₪99",
  "cart.suggest.blanketPromo": "₪89",
  ...
  "home.howItWorks.cta": "Start here",
  ...
  "home.special.title": "Why Choose Us",
  "home.special.titleHighlight": "Us",
  "home.special.subtitleLine1": "We searched and couldn't find it - so we invented it.",
  "home.special.ariaLabel": "Why Choose Us",
  ...
  "contact.sidebarTitle": "How can we help?",
  "contact.sidebarSubtitle":
    "We'd love to hear from you — we'll get back within 24 business hours",
  "contact.mobileSubtitle":
    "We'd love to hear from you — we'll get back within 24 hours",
  "contact.orDivider": "or",
  "contact.responseTime": "Response time: up to 24 hours",
  "contact.supportEmail": "support@littlegali.com",
  "contact.deliveryTime": "Orders arrive within up to 14 business days",
  "contact.sidebarReturns": "Return Policy",
  "contact.sidebarOrderTracking": "Order Tracking",
  "contact.sidebarFaq": "FAQ",
  ...
  "contact.emailPlaceholder": "your@email.com",
  "contact.subjectPlaceholder": "About an order / product / general question",
  "contact.messagePlaceholder": "Tell us everything — we'd love to help",
  ...
  "contact.previewLinked":
    "If you have one, your preview will be sent to us automatically with your message so we understand what it's about",
  "contact.previewLinkedMobile":
    "If your message relates to an existing order, your preview will be sent automatically",
  "contact.attachments": "Attach photos (optional)",
  "contact.attachmentsLimitHint": "Up to 5 photos",
  "contact.attachmentsLimitHintShort": "Up to 5",
  ...
  "upload.description":
    "Select 5 photos that will appear in the book.\nFrom each photo we'll create a color illustration and a black-and-white illustration.",
  "upload.descriptionColorful":
    "Select 9 photos that will appear in the colorful booklet.",
  "upload.colorfulMirrorNote":
    "One page has a built-in safety mirror — so you choose 9 photos (5 on one side and 4 on the other).",
  "upload.imagesCount": "out of 5",
  "upload.imagesCount9": "out of 9 photos",
  "upload.selectExactly5": "Please select exactly 5 photos",
  "upload.selectExactly9": "Please select exactly 9 photos",
  "upload.chooser.ariaLabel": "Choose booklet type",
  "upload.chooser.title": "Which booklet would you like to create?",
  ...
  "upload.chooser.classicBadge": "5 photos",
  "upload.chooser.classicFeature1": "Black & white side",
  "upload.chooser.classicFeature2": "Second side in color",
  "upload.chooser.classicFeature3": "Includes a mirror",
  "upload.chooser.classicFeature4": "5 photos",
  "upload.chooser.colorfulTitle": "Colorful booklet",
  "upload.chooser.colorfulDescription":
    "Both sides include different colorful photos",
  "upload.chooser.colorfulBadge": "9 photos",
  "upload.chooser.colorfulFeature1": "Two colorful sides",
  "upload.chooser.colorfulFeature2": "Different photos on each side",
  "upload.chooser.colorfulFeature3": "Includes a mirror",
  "upload.chooser.colorfulFeature4": "9 photos",
  ...
  "upload.previousSessions.cardTitle": "Your book is waiting",
  "upload.previousSessions.sectionTitle": "Pick up where you left off",
  "upload.previousSessions.continue": "Continue where you left off",
  "upload.previousSessions.goToCart": "Go to cart",
  "upload.previousSessions.viewPreview": "View preview",
  "upload.previousSessions.dismissSession": "Dismiss",
  "upload.previousSessions.orUploadNew": "Or upload new photos below",
  "upload.previousSessions.orChooseType": "Or create a new booklet below",
  "upload.previousSessions.badge.classic": "Classic booklet · 5 photos",
  "upload.previousSessions.badge.colorful": "Colorful booklet · 9 photos",
  "upload.previousSessions.resumeError": "We couldn't open that preview. Please try again.",
  "upload.previousSessions.createdRelative": "Created {relative}",
  "upload.previousSessions.updatedYesterday": "Yesterday",
  "upload.previousSessions.changesRemaining": "{count} changes left",
  "upload.previousSessions.changesExhausted": "No changes left · you can still order",
  "upload.previousSessions.status.generating": "Preparing preview",
  "upload.previousSessions.status.reviewBw": "Review black & white",
  "upload.previousSessions.status.pickStyle": "Pick a style",
  "upload.previousSessions.status.readyToOrder": "Ready to order",
  "upload.previousSessions.status.inCart": "In your cart",
