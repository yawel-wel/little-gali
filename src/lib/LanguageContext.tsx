...
const hebrewTranslations = {
  ...
  "framedArt.preview.loadingLine1": "עובדים על הסגנון שבחרתם",
  "framedArt.preview.loadingLine2": "מוסיפים עוד קצת צבע",
  "framedArt.preview.loadingLine3": "פינישים אחרונים",
  "framedArt.preview.loadingLine4": "בודקים שהכל נראה טוב",
...
const englishTranslations = {
  ...
  "framedArt.preview.loadingLine1": "Working on the style you chose",
  "framedArt.preview.loadingLine2": "Adding a bit more color",
  "framedArt.preview.loadingLine3": "Final touches",
  "framedArt.preview.loadingLine4": "Making sure everything looks good",
