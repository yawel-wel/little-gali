...
const hebrewTranslations = {
  ...
  "preview.colorPhaseTitle": "הצד הצבעוני",
  "preview.bwPhaseDescription": "זה השלב שבו אפשר לשנות תמונות. לאחר המעבר לצד הצבעוני לא ניתן יהיה להחליף תמונות.",
  "preview.bwApproveAbove": "אהבתם? אם הכל נראה טוב אפשר לעבור לצד הצבעוני",
  "preview.bwApproveBelow": "אחרי המעבר לצד הצבעוני לא תוכלו לשנות את התמונות",
  "preview.approveBwButton": "לעבור לצד הצבעוני",
  "preview.bwLoadingTitle": "יוצרים את התמונות שלכם",
  "preview.bwLoadingLine1": "יוצרים את התמונות שלכם",
  "preview.bwLoadingLine2": "מכינים את הצד השחור לבן",
  "preview.bwLoadingLine3": "מנתחים את התמונות",
  "preview.bwLoadingLine4": "מעלים את הקונטרסט",
  ...
  "preview.subtitle":
    "ניתן לבצע עד 3 שינויים ולסדר את התמונות מחדש באמצעות גרירה.",
  ...
  "preview.changesExhaustedLine1": "נגמרו השינויים להיום",
  "preview.changesExhaustedLine2": "אפשר לבחור מהתמונות שנוצרו",
  "preview.changesExhaustedLine3": "או ליצור איתנו קשר",
...
const englishTranslations = {
  ...
  "preview.colorPhaseTitle": "The Color Side",
  "preview.bwPhaseDescription": "This is the step where you can change images. After moving to the color side, you won't be able to replace images.",
  "preview.bwApproveAbove": "Happy with it? If everything looks good, you can move to the color side",
  "preview.bwApproveBelow": "After moving to the color side, you won't be able to change the images",
  "preview.approveBwButton": "Move to the color side",
  "preview.bwLoadingTitle": "Creating your images",
  "preview.bwLoadingLine1": "Creating your images",
  "preview.bwLoadingLine2": "Preparing the black & white side",
  "preview.bwLoadingLine3": "Analyzing your photos",
  "preview.bwLoadingLine4": "Enhancing the contrast",
  ...
  "preview.subtitle":
    "You can make up to 3 changes and reorder the photos by dragging.",
  ...
  "preview.changesExhaustedLine1": "You've used today's changes",
  "preview.changesExhaustedLine2": "You can choose from the images already created",
  "preview.changesExhaustedLine3": "or contact us",
