...
const hebrewTranslations = {
  ...
  "styleSelector.modal.watercolor.flowing": "סגנון זורם ורענן",
  "styleSelector.modal.watercolor.dreamy": "גימור אומנותי",
  "styleSelector.modal.watercolor.organic": "צבעים אורגניים",
  "styleSelector.modal.watercolor.artistic": "פחות מדויק לפרטים",
...
const englishTranslations = {
  ...
  "styleSelector.modal.watercolor.flowing": "Flowing and fresh style",
  "styleSelector.modal.watercolor.dreamy": "Dreamy and soft appearance",
  "styleSelector.modal.watercolor.organic": "Organic colors",
  "styleSelector.modal.watercolor.artistic": "Artistic finish",
